...
function createSolutionPage(solution, template) {
    ...
    html = html.replace('{{SIMILAR_PROBLEMS}}', solution.similarProblems ? `<div class="similar-problems"><strong>🔗 Similar Problems:</strong> ${escapeHtml(solution.similarProblems)}</div>` : '');
